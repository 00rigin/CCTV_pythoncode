...
class device:
    def __init__(self):
        ...
        self.createDevice("192.168.0.4")  # Worker 3
        self.createDevice("192.168.0.6")  # Worker 3
        # self.createDevice("192.168.0.12") #Worker 1
        # self.createDevice("192.168.0.9") #Worker 1
        # self.createDevice("192.168.0.14") #Worker 2
        # self.createDevice("192.168.0.15") #Worker 2
        return
    ...
    def deviceExtraction(self):
        ...
        for q in self.queueList:
            result['videoQuality'].append(720)
            result['videoRate'].append(100)
